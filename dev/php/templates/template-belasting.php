...
<div class="bluebackground"><!-- Dit is de achtergrond -->
	<div class="u-gridContainer">
		<div class="columbackground-belasting">
				...
				<div class="u-gridRow">
					<div class="u-gridCol12">
						<div class="belastingCheck">
							<span id="spanzondermargin">Controleer uw aanslag direct na ontvangst en twijfelt u over de juistheid maak dan snel bezwaar. U heeft maar zes weken na de dagtekening!</span>
						</div>
					</div>
					<div class="u-gridCol12">
						<div class="belastingCheckFoto">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/belastingbrief.png">
						</div>
					</div>
				</div>
			</div>
